          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-left">
                <button class="btn btn-default btn-flat" data-toggle="modal" data-target="#logout">&nbsp;Sign Out</button></td>
                </div>
              </li>
            </ul>
          </li>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <h4><p><center>Apakah <?= session()->get('fullname') ?> Ingin Keluar Dari Sistem ?</b></center></p></h4>
