            ...
            <table id="example1" class="table table-bordered table-striped ">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= $value['jumlah_distribusi_produk']; ?></td>
                            <td><?= date('d-m-Y', strtotime($value['tanggal_distribusi_produk'])); ?></td>
...
<!-- Modal delete-->
<?php foreach ($data_laporan_admin as $key => $value) { ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h4><p>
                        <center>Apakah Anda Ingin Menghapus Data Laporan Produk Ini ? </center>
                    </p></h4>
